...
namespace tcp {
    struct async_socket {
        ...
        void read(struct io_service*, size_t, std::function<void(int, async_socket*, size_t, void*)>);
        void read_some(struct io_service*, size_t, std::function<void(int, async_socket*, size_t, void*)>);
